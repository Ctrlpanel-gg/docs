...
:::caution
This guide is for updates 1.2.x -> 1.2.x

If you want to upgrade from version 1.1.x to 1.2.x, please follow [1.1.x](/docs/updating/from-1.1.x) update guide first, then this guide as needed.
:::
