...
After clearing caches, open your application Settings, navigate to the User tab, and click Save. This refreshes permissions and credit calculations for normal runtime behavior.
